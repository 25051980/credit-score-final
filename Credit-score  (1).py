...
# Calcular a média da coluna 'mau' agrupada por 'estado_civil'
media_por_estado_civil = df.groupby('estado_civil')['mau'].mean()

# Criar o gráfico de barras
grafico_barras = media_por_estado_civil.plot(kind='bar')

# Definir os rótulos e título do gráfico
plt.xlabel('Estado Civil')
plt.ylabel('Média de Mau')
plt.title('Média de Mau por Estado Civil')
...
# Limpar os valores negativos em 'tempo_emprego'
var = "tempo_emprego"
df.loc[df[var] < 0, var] = -2

# Limpar a figura atual antes de criar um novo gráfico
plt.clf()

# Criar o gráfico de distribuição (histograma) usando seaborn
sns.displot(df, x=var, bins=50)
